...
*/
namespace Kitchen\News\Model\ResourceModel\Gallery\Grid;
 
use Magento\Framework\Api\Search\SearchResultInterface;
use Magento\Framework\Api\Search\AggregationInterface;
use Kitchen\News\Model\ResourceModel\Gallery\Collection as PageCollection;
    ...
    protected function _initSelect()
        {
            ...
            $this->getSelect()->joinLeft(
                ['AT' => $this->getTable('admin')], //2nd table name by which you want to join mail table
