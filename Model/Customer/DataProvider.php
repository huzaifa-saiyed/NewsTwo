...
namespace Kitchen\News\Model\Customer;
...
class DataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    ...
    public function getData()
    {
        ...
        foreach ($items as $product) {
            ...
            $productData['profile_image'] = [];
            $productData['newsletter_subscription'] = explode(',', $product->getNewsletterSubscription());
            $mediapath = $this->_filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath($this->imageUploader::BASE_TMP_PATH);
 
            $fileName = $product->getProfileImage();
            ...
            if ($this->fileDriver->isExists($filePath) && $this->fileDriver->isFile($filePath)) {
                ...
                $productData['profile_image'] = [
                    [
                        'name' =>  $fileName,
                        'url' => $this->getMediaUrl().$this->imageUploader::BASE_TMP_PATH. $product->getProfileImage(),
